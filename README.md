...
- Current weather card with temperature, description, feels-like vs actual, humidity, pressure, visibility, wind, sunrise, and sunset.[web:17][web:19]
...
- Next 24 hours:
  ...
  - Wind & humidity chart with dual y-axis (wind + humidity).[web:17][web:20]
- Air Quality Index (AQI) and UV Index using OpenWeather Air Pollution and One Call APIs.[web:21]
...
- Voice search via `webkitSpeechRecognition` (where supported).[web:22][web:25]
...
- Interactive Leaflet map with click‑to‑load weather for any point.[web:17][web:23][web:26]
...
- Glassmorphism cards with blur, gradients, and shadows for a modern look.[web:17]
...
![Main Dashboard](screenshots/main-dashboard%20copy.png "Main weather dashboard")

![Weather AI & Hourly View](screenshots/hourly-ai-section.png "AI advice and hourly forecast")

![Forecast & Map](screenshots/forecast-map.png "5‑day forecast and map view")
